...
interface IOrbitWork {
    ...
    event ReactiveCallbackSenderUpdated(address indexed newSender);
    ...
    function autoApproveMilestone(uint256 escrowId, uint256 milestoneIndex) external;
    ...
    function verifyUserIdentity(address user) external;
    function revokeUserVerification(address user) external;
    ...
    function extendDeadline(uint256 escrowId, uint256 extension) external;
    function rateFreelancer(uint256 escrowId, uint256 rating) external;
    function getFreelancerRating(address freelancer) external view returns (uint256 averageRating, uint256 totalRatings);
    function getEscrowRating(uint256 escrowId) external view returns (address rater, address freelancer, uint256 rating, uint256 ratedAt, bool exists);
    function getBadgeTier(address freelancer) external view returns (uint256);
